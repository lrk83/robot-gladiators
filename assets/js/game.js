    ...
    for (var i = 0; i < enemyInfo.length; i++) {
        ...
        if (playerInfo.health > 0) {
            ...
            if (i<enemyInfo.length-1 && playerInfo.health>0){
                if(window.confirm("would you like to shop")) {
                    shop();
                }
            }
        }
...
var shop = function(){
    var shopOptionPrompt = window.prompt("Would you like to REFILL your health, UPGRRADE your attack, or LEAVE the store"+
